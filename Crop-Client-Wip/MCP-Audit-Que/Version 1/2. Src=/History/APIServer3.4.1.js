/**
 * APIServer3.4.1.js — CropManage MCP Server (same folder as HTML src= scripts)
 * Source: 2. Src=/APIServer3.4.1.js | Deploy: crop-client-services/api-server/
 * Run: from Version 1 folder: node "2. Src=/APIServer3.4.1.js" | Port: 3101
 *
