...
- Server SOURCE (only truth): C:\AICode\crop-client-services\api-server\APIServer2.0.js
- API Component (stale):  v2.0-apiupdate/TestHarness/AIToolKit/Client-AI-Component.js
- Saved data:           C:\AICode\crop-client-services\api-server\data\
- After harness passes → export to APIServer2.1.js + api-component.2.1.js
