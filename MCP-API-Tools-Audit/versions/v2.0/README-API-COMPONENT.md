...
| Source of Truth | App HTML: `CropClient-MCP-API-Tools-Audit-Q-v1_1.html` |
...
┌─────────────────────────────────────────────────────────────────┐
│                     SOURCE OF TRUTH                             │
│         CropClient-MCP-API-Tools-Audit-Q-v1_1.html              │
│                                                                 │
...
| File | Path | Purpose |
|------|------|---------|
| App (Source) | `C:\AICode\CropClient-Claude-Desktop\MCP-API-Tools-Audit\CropClient-MCP-API-Tools-Audit-Q-v1_1.html` | Source of truth |
| Component | `C:\AICode\CropClient-Claude-Desktop\MCP-API-Tools-Audit\api-component.js` | Extracted API logic |
| Server | `C:\AICode\crop-client-services\api-server\APIServer.js` | MCP server (production) |
...
const tools = [
    {
        ...
        description: "Refresh irrigation details for selected ranch/planting.",
        inputSchema: {
            type: "object",
            properties: {
                ranchId: { type: "string" },
...
*CropClient MCP API Server v1.1*
