/**
 * APIServer5.0.js — CropManage MCP Server
 * Base: user's working APIServer3.4.1.js (confirmed correct up to get_irrigation_details)
...
class MCPServer {
    ...
    start() {
        ...
        process.stderr.write('APIServer5.0 started - stdio mode\n');
    }
}
