...
app.get('/ping', (req, res) => {
    res.json({ 
        ...
        tools: apiServiceTools.length
    });
});

// List tools
app.get('/tools', (req, res) => {
    const toolList = apiServiceTools.map(t => ({
        name: t.name,
...
app.post('/tools/:toolName', async (req, res) => {
    ...
    try {
        const tool = apiServiceTools.find(t => t.name === toolName);
...
app.listen(PORT, () => {
    ...
    console.log(`📋 Tools available: ${apiServiceTools.length}`);
