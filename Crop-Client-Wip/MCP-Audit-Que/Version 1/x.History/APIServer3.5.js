/**
 * APIServer3.5.js — CropManage MCP Server
 * Source: 2. Src= (truth copy) | Deploy: crop-client-services/api-server/
 * Run: node APIServer3.5.js | Port: 3101
 *
 * Changes v3.4 → v3.5:
 *   - Matches api-component-3.3 fix (get_irrigation_details with plantingId param)
 *   - get_irrigation_details handler ready for corrected client calls
 */
