...
// --- mcp-engine-mode ---
// Owned by mcp-engine, set by the env dropdown (setEnvMode, in
// DOM-water-objects.html). Every token in api-water-science.js and
// MCP-Water-Tools.js reads this directly — the one source of truth for
// offline/local/online routing.
let mcpMode = 'local'; // 'offline' | 'local' | 'online'
function setMcpMode(value) {
    mcpMode = value;
}
