/**
 * APIServer3.3.js — CropManage MCP Server
 * Source: 2. Src= (truth copy) | Deploy: crop-client-services/api-server/
 * Run: node APIServer3.3.js | Port: 3101
 *
 * Changes v3.2 → v3.3:
 *   - getMcpBase + mcpCall added to server injection point (live, usable)
 *   - Version numbers aligned with api-component-3.3.js
 */
