/**
 * API MCP Server - CropManage Integration v1.3
 ...
 *
 * Changes from v1.2:
 *   - PORT reads from process.env.PORT for iisnode (falls back to 3101)
 *   - stdio MCP server.start() only runs when NOT under iisnode
...
app.get('/ping', (req, res) => {
    res.json({
        status: 'alive',
        server: 'CropClient API MCP v1.3',
...
// Start HTTP server
app.listen(PORT, () => {
    console.log(`API MCP Server v1.3 running on port ${PORT}`);
