// ========================================
// irrigation-component-1.0.js
// ========================================
// Source: CropClient-MCP-API-Tools-Audit-Q-v1.6-1.2s.html
// Lineage: v1.6-1.2s (high water mark) -> Que-1.0 -> this file
// Built: 2026-03-28
//
...
//
// Helpers (2):
//   1. parseEventDate  - Parse MM/DD/YY string to Date
//   2. formatDate      - Format Date to MM/DD/YY string
//
// MCP Registry:
//   mcpTools{} - 6 tool definitions with inputSchema + handler
//   callTool() - dispatcher
// ========================================

// ----------------------------------------
// HELPER: parseEventDate
// Parses MM/DD/YY date string to Date object
// ----------------------------------------
...
// ----------------------------------------
// HELPER: formatDate
// Formats Date object to MM/DD/YY string
// ----------------------------------------
...
// ========================================
// MCP TOOLS REGISTRY
// inputSchema + handler for each tool
// Handlers bridge pure functions to UI
// ========================================
